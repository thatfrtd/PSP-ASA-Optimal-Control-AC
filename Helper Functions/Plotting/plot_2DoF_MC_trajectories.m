function [] = plot_2DoF_MC_trajectories(t_mean, x_mean, t_fb, x_MC_fb, x_ref, t_k, P_k, t_no_fb, x_MC_no_fb, Pf, glideslope_angle, h_glideslope, options)
arguments
    t_mean
    x_mean
    t_fb
