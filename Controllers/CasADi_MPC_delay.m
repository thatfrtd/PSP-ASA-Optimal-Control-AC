classdef CasADi_MPC_delay < matlab.System
    ...
    methods
        function obj = CasADi_MPC_delay(varargin)
    ...
    methods (Access = protected)
        ...
        function [x_opt, u_opt, t_opt, x_pred] = stepImpl(obj,x_current)
